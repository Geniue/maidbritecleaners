...
@section('meta')
    <meta name="title" content="About Us | MaidBrite Cleaners">
    <meta name="description"
        content="Discover MaidBrite Cleaners, a trusted provider of house cleaning services, offering deep cleaning, move in/out, and post construction cleaning. Committed to green, sanitizing solutions!">
    <meta name="keywords"
    ...
    <meta property="og:title" content="About Us | MaidBrite Cleaners">
    ...
    <meta name="twitter:title" content="MaidBrite CleanersHouse and Commercial Cleaning in NYC  | MaidBrite Cleaners">
...
@section('content')
    ...
    <section>
        <div class="container py-5 text-lightgray">
            ...
            <p>
                At MaidBrite Cleaners, we're passionate about delivering exceptional house cleaning services, right
            ...
            <p>
                Perhaps you’re searching for maids near you, or a move-out cleaning service? MaidBrite Cleaners is
            ...
            <p>
                ...
                environment right to your doorstep. At MaidBrite Cleaners, we offer more than just a service. We deliver a promise
                of exceptional quality, deep cleaning services near you, and most importantly, your satisfaction.
            </p>
            <p>
                Come home to a cleaner house. Come home to MaidBrite Cleaners.
            </p>
        </div>
    </section>
