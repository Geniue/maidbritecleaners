...
@section('meta')
    ...
    <meta property="og:image" content="{{ asset('assets/images/geo_services/11206--NY--Brooklyn-House-Cleaning-House-Cleaning-cleaners-near-me.jpg') }}">
    ...
    <meta name="twitter:description"
        content="Experience exceptional house cleaning services with Maidbrite Cleaning Services . From deep cleaning to move in and move out cleaning services, our professional team is dedicated to keeping your home spotless and comfortable. Trust us for reliable, high-quality and affordable cleaning solutions near you.">
    <meta name="twitter:image" content="{{ asset('assets/images/geo_services/11206--NY--Brooklyn-House-Cleaning-House-Cleaning-cleaners-near-me.jpg') }}">
    <meta name="twitter:url" content="{{ url()->current() }}">
    <meta name="twitter:card" content="summary">

    <meta itemprop="name" content="Maidbrite Cleaning Services ">
    <meta itemprop="url" content="{{ url()->current() }}">
    <meta itemprop="thumbnailUrl" content="{{ asset('assets/images/geo_services/11206--NY--Brooklyn-House-Cleaning-House-Cleaning-cleaners-near-me.jpg') }}">
    <meta itemprop="image" content="{{ asset('assets/images/geo_services/11206--NY--Brooklyn-House-Cleaning-House-Cleaning-cleaners-near-me.jpg') }}">
    <link rel="image_src" href="{{ asset('assets/images/geo_services/11206--NY--Brooklyn-House-Cleaning-House-Cleaning-cleaners-near-me.jpg') }}">
...
@section('content')
    ...
    <main class="position-relative">
        ...
        <picture class="lozad ser-banner">
            <source media="(max-width: 878px)" srcset="{{ asset('assets/images/geo_services/11206--NY--Brooklyn-House-Cleaning-House-Cleaning-cleaners-near-me.jpg') }}">
            <source media="(min-width: 878px)" srcset="{{ asset('assets/images/geo_services/11206--NY--Brooklyn-House-Cleaning-House-Cleaning-cleaners-near-me.jpg') }}">
            <img class="service-bannner-img h-img-600" src="{{ asset('assets/images/geo_services/11206--NY--Brooklyn-House-Cleaning-House-Cleaning-cleaners-near-me.jpg') }}"
                alt="House Cleaning">
        </picture>
