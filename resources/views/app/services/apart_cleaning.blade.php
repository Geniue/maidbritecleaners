...
@section('meta')
    ...
    <meta property="og:image" content="{{ asset('assets/images/geo_services/11206--NY--Brooklyn-Apartment-Cleaning--Apartment-Cleaning--apartment-cleaning-services.jpg') }}">
    ...
    <meta name="twitter:description"
        content="Discover superior apartment cleaning services with Maidbrite Cleaning Services . We offer a variety of professional cleaning services, including deep cleaning, move-out cleaning, and regular maintenance, all tailored to your unique needs. Our competitively priced services, delivered by a team of professional cleaners, ensure your home is always pristine, comfortable, and inviting. Choose Maidbrite Cleaning Services  for unparalleled professionalism, quality, and customer satisfaction.">
    <meta name="twitter:image" content="{{ asset('assets/images/geo_services/11206--NY--Brooklyn-Apartment-Cleaning--Apartment-Cleaning--apartment-cleaning-services.jpg') }}">
    <meta name="twitter:url" content="{{ url()->current() }}">
    <meta name="twitter:card" content="summary">

    <meta itemprop="name" content="Maidbrite Cleaning Services ">
    <meta itemprop="url" content="{{ url()->current() }}">
    <meta itemprop="thumbnailUrl" content="{{ asset('assets/images/geo_services/11206--NY--Brooklyn-Apartment-Cleaning--Apartment-Cleaning--apartment-cleaning-services.jpg') }}">
    <meta itemprop="image" content="{{ asset('assets/images/geo_services/11206--NY--Brooklyn-Apartment-Cleaning--Apartment-Cleaning--apartment-cleaning-services.jpg') }}">
    <link rel="image_src" href="{{ asset('assets/images/geo_services/11206--NY--Brooklyn-Apartment-Cleaning--Apartment-Cleaning--apartment-cleaning-services.jpg') }}">
    ...
    <main class="position-relative">
        ...
        <picture class="lozad">
            <source media="(max-width: 878px)"
                srcset="{{ asset('assets/images/geo_services/11206--NY--Brooklyn-Apartment-Cleaning--Apartment-Cleaning--apartment-cleaning-services.jpg') }}">
            <source media="(min-width: 878px)"
                srcset="{{ asset('assets/images/geo_services/11206--NY--Brooklyn-Apartment-Cleaning--Apartment-Cleaning--apartment-cleaning-services.jpg') }}">
            <img class="service-bannner-img h-img-600"
                src="{{ asset('assets/images/geo_services/11206--NY--Brooklyn-Apartment-Cleaning--Apartment-Cleaning--apartment-cleaning-services.jpg') }}"
